...
public partial class NyElectricBlastFurnaceRecipe : Recipe
{
    public NyElectricBlastFurnaceRecipe()
    {
		...
		new CraftingElement<Eco.Mods.TechTree.ScrewsItem>(typeof(IndustrySkill), 40f, IndustrySkill.MultiplicativeStrategy),
		new CraftingElement<Eco.Mods.TechTree.SteelItem>(typeof(IndustrySkill), 40f, IndustrySkill.MultiplicativeStrategy, typeof(IndustryLavishResourcesTalent)),
